...
carrotcake.initialise('runtime_params.nml')
offset_step = (2 * math.pi) / carrotcake.runtime_parameters.nx
...
for ii in range (0, carrotcake.runtime_parameters.koverall):
    ...
    data = {'xvals': carrotcake.global_variables.xvals,
        'yvals': carrotcake.global_variables.yvals}
